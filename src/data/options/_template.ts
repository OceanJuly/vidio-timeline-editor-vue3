import { mappingFormItem } from '@/utils/formItem'
											...
											children: [
												mappingFormItem('CollapsePane', {
													...
													children: [
														...
														mappingFormItem('String', {
															attr: { placeholder: '请输入数字' },
															name: 'string',
															mappingKey: 'color3'
														}),
														mappingFormItem('Radio', {
															name: 'Radio',
															mappingKey: 'color4',
															defaultValue: 'o1',
															children: [
																mappingFormItem('RadioItem', {
																	name: 'o1',
																	value: 'o1'
																}),
																mappingFormItem('RadioItem', {
														...
														mappingFormItem('RadioButton', {
															name: 'Radio',
															mappingKey: 'color5',
															defaultValue: 'o1',
															children: [
																mappingFormItem('RadioButtonItem', {
																	name: 'o1',
																	value: 'o1'
																}),
																mappingFormItem('RadioButtonItem', {
