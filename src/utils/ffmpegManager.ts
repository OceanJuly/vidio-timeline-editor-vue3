...
import { FileTypeMap } from '@/data/constant.ts'
import type { RunTask, TrackItem } from '@/types'
import { Command } from '@/utils/ffmpegCommand.ts'
