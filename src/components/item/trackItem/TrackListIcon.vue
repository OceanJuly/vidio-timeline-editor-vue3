<template>
	<div
		ref="iconList"
		class="relative w-12 flex h-full flex-col items-center justify-start overflow-hidden border-r dark:border-gray-600 border-gray-300"
	>
		<!--	与右侧刻度线同高，站位 dom	-->
		<span
...
<script setup lang="ts">
	...
	import { TrackHeightMap } from '@/data/trackConfig.ts'
